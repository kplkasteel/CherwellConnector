...
namespace CherwellConnector.Interface
{
    ...
    public interface ICoreApi : IApiAccessor
    {
        ...
        string CoreGetGalleryImageV1(string name, int? width = null, int? height = null, string lang = null,
            string locale = null);
        ...
        ManagerData CoreGetGalleryImagesFolderV1(string scope, string scopeowner, string folder, bool? links = null,
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData CoreGetGalleryImagesScopeOwnerV1(string scope, string scopeowner, bool? links = null,
            string lang = null, string locale = null);
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData CoreGetGalleryImagesScopeV1(string scope, bool? links = null, string lang = null,
            string locale = null);
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData CoreGetStoredValuesFolderV1(string scope, string scopeowner, string folder, bool? links = null,
            string lang = null, string locale = null);
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData CoreGetStoredValuesScopeOwnerV1(string scope, string scopeowner, bool? links = null,
            string lang = null, string locale = null);
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData CoreGetStoredValuesScopeV1(string scope, bool? links = null, string lang = null,
            string locale = null);
        ...
        /// </summary>
        /// <remarks>
        ///     Endpoint to Create or update a gallery image. To create a new gallery image leave the StandIn key blank. To update
        ///     a gallery image provide the StandIn key of the gallery image you want to update.&lt;/br&gt;There are three
        ///     different ImageTypes allowed: Imported, Url, and File. To use the Imported image type, provide the filename in the
        ///     Name property, with extension, and provide the image data in a Base64 encoded format in the Base64EncodedImageData
        ///     property. The max file size is 512k.&lt;/br&gt;To use the Url image type,  provide the full network share path to
        ///     the file in the Name property, ie: \&quot;\\\\\\\\\\\\\\\\networkshare\\\\\\somefolder\\\\\\somefile.jpg\&quot;. If
        ///     the file is not accessible to all users it will not visible to all users.&lt;/br&gt;To use the File image type,
        ///     provide the full path to the file in the Name property, ie: \&quot;C:\\\\\\somefolder\\\\\\somfile.jpg\&quot;. If
        ///     the file is not accessible to all users it will not visible to all users.&lt;/br&gt;When creating or updating an
        ///     image, Name and ImageType are always required, and if the image type is \&quot;Imported\&quot;, then the
        ///     Base64EncodedImageData is also required. &lt;/br&gt;scope, scopeowner, and folder can all be updated independently.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="request">
        ...
        SaveGalleryImageResponse CoreSaveGalleryImageV1(SaveGalleryImageRequest request, string lang = null,
            string locale = null);
        ...
        /// </summary>
        /// <remarks>
        ///     Operation to create or update a stored value. To update, specify the StandIn key for the stored value to update. To
        ///     create leave StandIn key blank, and provide a name, a scope, a type, and a value.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="request">
        ...
        /// </param>
        /// <returns>StoredValueResponse</returns>
        StoredValueResponse CoreSaveStoredValueV1(SaveStoredValueRequest request, string lang = null,
            string locale = null);
        ...
        /// </summary>
        /// <remarks>
        ///     Operation to update the current users culture by culture code. This returns a new access token that has the updated
        ///     information in it.
        /// </remarks>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
