...
namespace CherwellConnector.Interface
{
    ...
    public interface IQueuesApi : IApiAccessor
    {
        ...
        AddItemToQueueResponse QueuesAddItemToQueueV1(AddItemToQueueRequest request, string lang = null,
            string locale = null);
        ...
        CheckInQueueItemResponse QueuesCheckInQueueItemV1(CheckInQueueItemRequest request, string lang = null,
            string locale = null);
        ...
        CheckOutQueueItemResponse QueuesCheckOutQueueItemV1(CheckOutQueueItemRequest request, string lang = null,
            string locale = null);
        ...
        ManagerData QueuesGetQueuesFolderV1(string scope, string scopeowner, string folder, bool? links = null,
        ...
        /// </param>
        /// <returns>ManagerData</returns>
        ManagerData QueuesGetQueuesScopeOwnerV1(string scope, string scopeowner, bool? links = null, string lang = null,
            string locale = null);
        ...
        RemoveItemFromQueueResponse QueuesRemoveItemFromQueueV1(RemoveItemFromQueueRequest request, string lang = null,
            string locale = null);
    }
}