...
namespace CherwellConnector.Enum
{
    ...
    public enum StoredValueTypeEnum
    {
        ...
        /// </summary>
        [EnumMember(Value = "DateTime")] DateTime = 3,

        /// <summary>
        ///     Enum Logical for value: Logical
        /// </summary>
        [EnumMember(Value = "Logical")] Logical = 4,

        /// <summary>
        ///     Enum Color for value: Color
        /// </summary>
        [EnumMember(Value = "Color")] Color = 5,
        ...
        /// </summary>
        [EnumMember(Value = "JsonArray")] JsonArray = 7,

        /// <summary>
        ///     Enum Xml for value: Xml
        /// </summary>
        [EnumMember(Value = "Xml")] Xml = 8,

        /// <summary>
        ///     Enum XmlCollection for value: XmlCollection
        /// </summary>
        [EnumMember(Value = "XmlCollection")] XmlCollection = 9
    }
}