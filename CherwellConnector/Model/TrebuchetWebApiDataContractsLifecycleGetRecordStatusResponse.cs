...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse :  IEquatable<TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse(string id = default, string name = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Id = id;
            Name = name;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsLifecycleGetRecordStatusResponse input)
        {
            if (input == null)
                return false;
