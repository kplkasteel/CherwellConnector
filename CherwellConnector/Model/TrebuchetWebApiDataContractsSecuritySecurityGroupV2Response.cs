...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response :  IEquatable<TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response(List<TrebuchetWebApiDataContractsSecuritySecurityGroup> securityGroups = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecuritySecurityGroupV2Response input)
        {
            if (input == null)
                return false;
