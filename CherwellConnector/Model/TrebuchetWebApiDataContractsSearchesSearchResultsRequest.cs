...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesSearchResultsRequest :  IEquatable<TrebuchetWebApiDataContractsSearchesSearchResultsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesSearchResultsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesSearchResultsRequest input)
        {
            if (input == null)
                return false;
