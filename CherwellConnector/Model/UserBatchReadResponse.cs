...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class UserBatchReadResponse :  IEquatable<UserBatchReadResponse>, IValidatableObject
    {
        ...
        public UserBatchReadResponse(List<UserReadV2Response> responses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Responses = responses;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as UserBatchReadResponse);
        }
