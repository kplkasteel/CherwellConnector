...
namespace CherwellConnector.Model
{
    ...
    public sealed class Attachment : IEquatable<Attachment>, IValidatableObject
    {
        ...
        public Attachment(string attachedBusObId = default, string attachedBusObRecId = default,
            string attachmentFileId = default, string attachmentFileName = default, string attachmentFileType = default,
            string attachmentId = default, AttachmentTypeEnum? attachmentType = default, string busObId = default,
            string busObRecId = default, string comment = default, DateTime? created = default,
            string displayText = default, List<Link> links = default, string owner = default,
            ScopeEnum? scope = default, string scopeOwner = default, TypeEnum? type = default)
        {
