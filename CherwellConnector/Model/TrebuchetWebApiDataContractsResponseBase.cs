...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsResponseBase :  IEquatable<TrebuchetWebApiDataContractsResponseBase>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsResponseBase(string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsResponseBase);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsResponseBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsResponseBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsResponseBase input)
        {
            if (input == null)
                return false;
