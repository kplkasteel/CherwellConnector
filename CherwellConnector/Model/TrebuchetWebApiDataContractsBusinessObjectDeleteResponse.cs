...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectDeleteResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectDeleteResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsBusinessObjectDeleteResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectDeleteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectDeleteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectDeleteResponse input)
        {
            if (input == null)
                return false;
