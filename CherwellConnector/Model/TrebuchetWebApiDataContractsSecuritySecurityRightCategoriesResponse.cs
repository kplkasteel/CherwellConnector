...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse :  IEquatable<TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse(List<TrebuchetWebApiDataContractsSecurityRightCategory> rightCategories = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecuritySecurityRightCategoriesResponse input)
        {
            if (input == null)
                return false;
