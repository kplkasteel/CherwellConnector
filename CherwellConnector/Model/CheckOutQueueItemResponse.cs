...
namespace CherwellConnector.Model
{
    ...
    public sealed class CheckOutQueueItemResponse :  IEquatable<CheckOutQueueItemResponse>, IValidatableObject
    {
        ...
        public CheckOutQueueItemResponse(string historyRecId = default, string historyText = default, string historyTypeId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
