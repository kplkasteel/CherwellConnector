...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserListResponse :  IEquatable<TrebuchetWebApiDataContractsUsersUserListResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserListResponse(List<TrebuchetWebApiDataContractsUsersUserV2> users = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Users = users;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsUsersUserListResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserListResponse input)
        {
            if (input == null)
                return false;
