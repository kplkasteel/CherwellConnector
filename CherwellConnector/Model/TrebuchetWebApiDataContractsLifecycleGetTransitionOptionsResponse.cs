...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse :  IEquatable<TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse(List<TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponseTransition> transitions = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsLifecycleGetTransitionOptionsResponse input)
        {
            if (input == null)
                return false;
