...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityBusinessObjectPermission :  IEquatable<TrebuchetWebApiDataContractsSecurityBusinessObjectPermission>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityBusinessObjectPermission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityBusinessObjectPermission input)
        {
            if (input == null)
                return false;
