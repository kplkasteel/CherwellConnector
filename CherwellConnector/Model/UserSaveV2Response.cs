...
namespace CherwellConnector.Model
{
    ...
    public sealed class UserSaveV2Response :  IEquatable<UserSaveV2Response>, IValidatableObject
    {
        ...
        public UserSaveV2Response(string busObPublicId = default, string busObRecId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
