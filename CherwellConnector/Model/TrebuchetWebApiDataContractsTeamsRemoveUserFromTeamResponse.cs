...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsRemoveUserFromTeamResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsRemoveUserFromTeamResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsRemoveUserFromTeamResponse(string teamId = default, string userRecordId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            TeamId = teamId;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsRemoveUserFromTeamResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsRemoveUserFromTeamResponse input)
        {
            if (input == null)
                return false;
