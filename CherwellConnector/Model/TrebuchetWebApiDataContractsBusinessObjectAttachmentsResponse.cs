...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectAttachmentsResponse input)
        {
            if (input == null)
                return false;
