...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse :  IEquatable<TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse(string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityDeleteApiClientSettingsResponse input)
        {
            if (input == null)
                return false;
