...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserBatchReadResponse :  IEquatable<TrebuchetWebApiDataContractsUsersUserBatchReadResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsUsersUserBatchReadResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserBatchReadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserBatchReadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserBatchReadResponse input)
        {
            if (input == null)
                return false;
