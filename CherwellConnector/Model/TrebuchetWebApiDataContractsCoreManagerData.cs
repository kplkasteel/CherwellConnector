...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsCoreManagerData :  IEquatable<TrebuchetWebApiDataContractsCoreManagerData>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsCoreManagerData(TrebuchetWebApiDataContractsCoreManagerFolder root = default, List<NameValuePair> supportedAssociations = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Root = root;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsCoreManagerData);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsCoreManagerData instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsCoreManagerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsCoreManagerData input)
        {
            if (input == null)
                return false;
