...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsTeamsV2Response :  IEquatable<TrebuchetWebApiDataContractsTeamsTeamsV2Response>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsTeamsV2Response(List<TrebuchetWebApiDataContractsTeamsTeam> teams = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Teams = teams;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsTeamsV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsTeamsV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsTeamsV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsTeamsV2Response input)
        {
            if (input == null)
                return false;
