...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectTemplateResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectTemplateResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsBusinessObjectTemplateResponse(List<FieldTemplateItem> fields = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Fields = fields;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsBusinessObjectTemplateResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectTemplateResponse input)
        {
            if (input == null)
                return false;
