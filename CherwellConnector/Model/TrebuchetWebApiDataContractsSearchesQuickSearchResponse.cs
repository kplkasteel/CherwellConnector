...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesQuickSearchResponse :  IEquatable<TrebuchetWebApiDataContractsSearchesQuickSearchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSearchesQuickSearchResponse(TrebuchetWebApiDataContractsSearchesSearchResultsTableResponse searchResultsTable = default, TrebuchetWebApiDataContractsSearchesSimpleResultsList simpleResultsList = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSearchesQuickSearchResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSearchesQuickSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesQuickSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesQuickSearchResponse input)
        {
            if (input == null)
                return false;
