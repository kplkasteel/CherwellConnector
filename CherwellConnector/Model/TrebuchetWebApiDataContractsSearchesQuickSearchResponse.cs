...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsSearchesQuickSearchResponse :  IEquatable<TrebuchetWebApiDataContractsSearchesQuickSearchResponse>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SearchResultsTable: ").Append(this.SearchResultsTable).Append("\n");
            sb.Append("  SimpleResultsList: ").Append(this.SimpleResultsList).Append("\n");
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsSearchesQuickSearchResponse);
        }
        ...
        public bool Equals(TrebuchetWebApiDataContractsSearchesQuickSearchResponse input)
        {
            ...
            return 
                (
                    this.SearchResultsTable == input.SearchResultsTable ||
                    (this.SearchResultsTable != null &&
                    this.SearchResultsTable.Equals(input.SearchResultsTable))
                ) && 
                (
                    this.SimpleResultsList == input.SimpleResultsList ||
                    (this.SimpleResultsList != null &&
                    this.SimpleResultsList.Equals(input.SimpleResultsList))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SearchResultsTable != null)
                    hashCode = hashCode * 59 + this.SearchResultsTable.GetHashCode();
                if (this.SimpleResultsList != null)
                    hashCode = hashCode * 59 + this.SimpleResultsList.GetHashCode();
