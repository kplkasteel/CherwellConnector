...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse input)
        {
            if (input == null)
                return false;
