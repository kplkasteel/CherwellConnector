...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse :  IEquatable<TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse(List<TrebuchetWebApiDataContractsSecurityBusinessObjectPermission> businessObjectPermissions = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse);
        }
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityGetSecurityGroupBusinessObjectPermissionsResponse input)
        {
            if (input == null)
                return false;
