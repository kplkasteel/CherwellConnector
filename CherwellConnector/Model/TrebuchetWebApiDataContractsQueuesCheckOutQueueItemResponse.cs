...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse :  IEquatable<TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse(string historyRecId = default, string historyText = default, string historyTypeId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesCheckOutQueueItemResponse input)
        {
            if (input == null)
                return false;
