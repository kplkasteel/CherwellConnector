...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserDeleteV2Response :  IEquatable<TrebuchetWebApiDataContractsUsersUserDeleteV2Response>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserDeleteV2Response(string userRecordId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsUsersUserDeleteV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserDeleteV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserDeleteV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserDeleteV2Response input)
        {
            if (input == null)
                return false;
