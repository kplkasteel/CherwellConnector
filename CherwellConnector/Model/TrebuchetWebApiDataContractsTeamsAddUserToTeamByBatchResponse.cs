...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse(List<TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse> responses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Responses = responses;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsAddUserToTeamByBatchResponse input)
        {
            if (input == null)
                return false;
