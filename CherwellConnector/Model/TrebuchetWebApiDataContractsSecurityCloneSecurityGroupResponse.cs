...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse :  IEquatable<TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse(string securityGroupId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityCloneSecurityGroupResponse input)
        {
            if (input == null)
                return false;
