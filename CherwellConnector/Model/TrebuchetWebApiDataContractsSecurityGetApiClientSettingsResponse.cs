...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse :  IEquatable<TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse(List<TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponseItem> settings = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Settings = settings;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityGetApiClientSettingsResponse input)
        {
            if (input == null)
                return false;
