...
namespace CherwellConnector.Model
{
    ...
    /// <summary>
    /// RemoveItemFromQueueResponse
    /// </summary>
    [DataContract]
    public sealed class RemoveItemFromQueueResponse :  IEquatable<RemoveItemFromQueueResponse>, IValidatableObject
    {
        ...
        public RemoveItemFromQueueResponse(string historyRecId = default, string historyText = default, string historyTypeId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoveItemFromQueueResponse {\n");
        ...
        {
            return Equals(input as RemoveItemFromQueueResponse);
        }

        /// <summary>
        /// Returns true if RemoveItemFromQueueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveItemFromQueueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveItemFromQueueResponse input)
        {
            if (input == null)
                return false;
