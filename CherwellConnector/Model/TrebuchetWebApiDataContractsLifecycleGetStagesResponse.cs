...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsLifecycleGetStagesResponse :  IEquatable<TrebuchetWebApiDataContractsLifecycleGetStagesResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsLifecycleGetStagesResponse(List<TrebuchetWebApiDataContractsLifecycleGetStagesResponseStages> stages = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Stages = stages;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsLifecycleGetStagesResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsLifecycleGetStagesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsLifecycleGetStagesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsLifecycleGetStagesResponse input)
        {
            if (input == null)
                return false;
