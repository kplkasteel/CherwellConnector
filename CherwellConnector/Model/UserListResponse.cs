...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class UserListResponse :  IEquatable<UserListResponse>, IValidatableObject
    {
        ...
        public UserListResponse(List<UserV2> users = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Users = users;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as UserListResponse);
        }
