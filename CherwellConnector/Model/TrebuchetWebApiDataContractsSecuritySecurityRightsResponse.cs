...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecuritySecurityRightsResponse :  IEquatable<TrebuchetWebApiDataContractsSecuritySecurityRightsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecuritySecurityRightsResponse(List<TrebuchetWebApiDataContractsSecurityRight> rights = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Rights = rights;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecuritySecurityRightsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecuritySecurityRightsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecuritySecurityRightsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecuritySecurityRightsResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    Rights == input.Rights ||
                    Rights != null &&
                    Rights.SequenceEqual(input.Rights)
                ) && 
                (
