...
namespace CherwellConnector.Model
{
    ...
    public sealed class UserBatchDeleteV2Response :  IEquatable<UserBatchDeleteV2Response>, IValidatableObject
    {
        ...
        public UserBatchDeleteV2Response(List<UserDeleteV2Response> responses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Responses = responses;
            ErrorCode = errorCode;
