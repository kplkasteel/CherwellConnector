...
namespace CherwellConnector.Model
{
    ...
    public sealed class QuickSearchSpecificByIdRequest : IEquatable<QuickSearchSpecificByIdRequest>, IValidatableObject
    {
        ...
        public QuickSearchSpecificByIdRequest(List<string> busObIds = default, string standIn = default,
            bool? ascending = default, bool? isBusObTarget = default, bool? nonFinalState = default,
            bool? searchAnyWords = default, bool? searchAttachments = default, bool? searchRelated = default,
            string searchText = default, SearchesChangedLimit selectedChangedLimit = default,
            string selectedSortByFieldId = default, bool? sortByRelevance = default,
            string specificSearchTargetId = default, bool? useSortBy = default)
        {
            BusObIds = busObIds;
            StandIn = standIn;
            Ascending = ascending;
