...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest :  IEquatable<TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesQuickSearchSpecificByIdRequest input)
        {
            if (input == null)
                return false;
