...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response :  IEquatable<TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response(List<TrebuchetWebApiDataContractsUsersUserSaveV2Response> responses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Responses = responses;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserBatchSaveV2Response input)
        {
            if (input == null)
                return false;
