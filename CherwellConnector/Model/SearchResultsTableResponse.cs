...
namespace CherwellConnector.Model
{
    ...
    public sealed class SearchResultsTableResponse :  IEquatable<SearchResultsTableResponse>, IValidatableObject
    {
        ...
        public SearchResultsTableResponse(List<SearchesField> columns = default, List<SearchResultsRow> rows = default, List<SortInfo> sorting = default, long? totalRows = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Columns = columns;
            Rows = rows;
            Sorting = sorting;
