...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsQueuesAddItemToQueueRequest :  IEquatable<TrebuchetWebApiDataContractsQueuesAddItemToQueueRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesAddItemToQueueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesAddItemToQueueRequest input)
        {
            if (input == null)
                return false;
