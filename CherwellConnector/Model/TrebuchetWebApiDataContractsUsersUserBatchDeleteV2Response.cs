...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response :  IEquatable<TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserBatchDeleteV2Response input)
        {
            if (input == null)
                return false;
