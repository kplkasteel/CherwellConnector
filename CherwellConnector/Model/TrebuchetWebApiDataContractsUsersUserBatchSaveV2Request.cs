...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserBatchSaveV2Request :  IEquatable<TrebuchetWebApiDataContractsUsersUserBatchSaveV2Request>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserBatchSaveV2Request(List<UserSaveV2Request> saveRequests = default, bool? stopOnError = default)
        {
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserBatchSaveV2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserBatchSaveV2Request input)
        {
            if (input == null)
                return false;
