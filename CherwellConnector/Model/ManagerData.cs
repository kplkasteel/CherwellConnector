...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class ManagerData :  IEquatable<ManagerData>, IValidatableObject
    {
        ...
        public ManagerData(ManagerFolder root = default, List<NameValuePair> supportedAssociations = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Root = root;
        ...
        {
            return Equals(input as ManagerData);
        }

        /// <summary>
        /// Returns true if ManagerData instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagerData input)
        {
            if (input == null)
                return false;
