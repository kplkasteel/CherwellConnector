...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectReadResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectReadResponse>, IValidatableObject
    {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsBusinessObjectReadResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectReadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectReadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectReadResponse input)
        {
            if (input == null)
                return false;
