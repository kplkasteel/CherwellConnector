...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesQuickSearchRequest :  IEquatable<TrebuchetWebApiDataContractsSearchesQuickSearchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSearchesQuickSearchRequest(List<string> busObIds = default, string searchText = default)
        {
            BusObIds = busObIds;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSearchesQuickSearchRequest);
        }
