...
namespace CherwellConnector.Model
{
    ...
    public sealed class SearchResultsResponse : IEquatable<SearchResultsResponse>, IValidatableObject
    {
        ...
        public SearchResultsResponse(List<ReadResponse> businessObjects = default, bool? hasPrompts = default,
            List<Link> links = default, List<Prompt> prompts = default,
            List<SearchesField> searchResultsFields = default, SimpleResultsList simpleResults = default,
            long? totalRows = default, bool? hasMoreRecords = default, string errorCode = default,
