...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesSearchItemResponse :  IEquatable<TrebuchetWebApiDataContractsSearchesSearchItemResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSearchesSearchItemResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSearchesSearchItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesSearchItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesSearchItemResponse input)
        {
            if (input == null)
                return false;
