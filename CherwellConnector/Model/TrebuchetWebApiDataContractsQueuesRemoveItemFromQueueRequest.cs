...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueRequest :  IEquatable<TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueRequest input)
        {
            if (input == null)
                return false;
