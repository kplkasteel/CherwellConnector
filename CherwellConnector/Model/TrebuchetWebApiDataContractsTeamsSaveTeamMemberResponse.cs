...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse(string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse input)
        {
            if (input == null)
                return false;
