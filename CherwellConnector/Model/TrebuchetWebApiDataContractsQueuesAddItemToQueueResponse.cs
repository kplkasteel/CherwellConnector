...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse :  IEquatable<TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse(string historyRecId = default, string historyText = default, string historyTypeId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesAddItemToQueueResponse input)
        {
            if (input == null)
                return false;
