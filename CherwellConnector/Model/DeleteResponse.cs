...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class DeleteResponse :  IEquatable<DeleteResponse>, IValidatableObject
    {
        ...
        public DeleteResponse(string busObId = default, string busObPublicId = default, string busObRecId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            BusObId = busObId;
        ...
        {
            return Equals(input as DeleteResponse);
        }
