...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest :  IEquatable<TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest(string busObId = default, string busObRecId = default, string historyNotes = default, string queueStandInKey = default)
        {
            BusObId = busObId;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesCheckInQueueItemRequest input)
        {
            if (input == null)
                return false;
