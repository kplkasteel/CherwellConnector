...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class MobileCredentialsModeResponse :  IEquatable<MobileCredentialsModeResponse>, IValidatableObject
    {
        ...
        public MobileCredentialsModeResponse(int? credentialsMode = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as MobileCredentialsModeResponse);
        }
