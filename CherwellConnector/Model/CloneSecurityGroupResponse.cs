...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class CloneSecurityGroupResponse :  IEquatable<CloneSecurityGroupResponse>, IValidatableObject
    {
        ...
        public CloneSecurityGroupResponse(string securityGroupId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloneSecurityGroupResponse {\n");
        ...
        {
            return Equals(input as CloneSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if CloneSecurityGroupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CloneSecurityGroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloneSecurityGroupResponse input)
        {
            if (input == null)
                return false;
