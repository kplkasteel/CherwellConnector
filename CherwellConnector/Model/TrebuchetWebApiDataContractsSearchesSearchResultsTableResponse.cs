...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesSearchResultsTableResponse :  IEquatable<TrebuchetWebApiDataContractsSearchesSearchResultsTableResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesSearchResultsTableResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesSearchResultsTableResponse input)
        {
            if (input == null)
                return false;
