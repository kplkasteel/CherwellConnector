...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class SecurityGroupBusinessObjectPermissionsResponse :  IEquatable<SecurityGroupBusinessObjectPermissionsResponse>, IValidatableObject
    {
        ...
        public SecurityGroupBusinessObjectPermissionsResponse(List<BusinessObjectPermission> businessObjectPermissions = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
