...
namespace CherwellConnector.Model
{
    ...
    public sealed class StatusesResponse :  IEquatable<StatusesResponse>, IValidatableObject
    {
        ...
        public StatusesResponse(List<StatusesResponseStatuses> statuses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Statuses = statuses;
            ErrorCode = errorCode;
