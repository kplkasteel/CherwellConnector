...
namespace CherwellConnector.Model
{
    ...
    public sealed class TeamsV2Response :  IEquatable<TeamsV2Response>, IValidatableObject
    {
        ...
        public TeamsV2Response(List<Team> teams = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Teams = teams;
            ErrorCode = errorCode;
