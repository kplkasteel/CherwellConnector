...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse(string workgroupId = default, string customerRecordId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsRemoveCustomerFromWorkgroupResponse input)
        {
            if (input == null)
                return false;
