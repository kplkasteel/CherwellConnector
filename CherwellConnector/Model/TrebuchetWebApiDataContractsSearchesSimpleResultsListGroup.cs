...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesSimpleResultsListGroup :  IEquatable<TrebuchetWebApiDataContractsSearchesSimpleResultsListGroup>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSearchesSimpleResultsListGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSearchesSimpleResultsListGroup input)
        {
            if (input == null)
                return false;
