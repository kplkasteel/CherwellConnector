...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsLifecycleGetStatusesResponse :  IEquatable<TrebuchetWebApiDataContractsLifecycleGetStatusesResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsLifecycleGetStatusesResponse(List<TrebuchetWebApiDataContractsLifecycleGetStatusesResponseStatuses> statuses = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Statuses = statuses;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsLifecycleGetStatusesResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsLifecycleGetStatusesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsLifecycleGetStatusesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsLifecycleGetStatusesResponse input)
        {
            if (input == null)
                return false;
