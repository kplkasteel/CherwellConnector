...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserSaveV2Response :  IEquatable<TrebuchetWebApiDataContractsUsersUserSaveV2Response>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserSaveV2Response(string busObPublicId = default, string busObRecId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsUsersUserSaveV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserSaveV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserSaveV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserSaveV2Response input)
        {
            if (input == null)
                return false;
