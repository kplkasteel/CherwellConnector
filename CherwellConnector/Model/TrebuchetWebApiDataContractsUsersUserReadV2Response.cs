...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserReadV2Response :  IEquatable<TrebuchetWebApiDataContractsUsersUserReadV2Response>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsUsersUserReadV2Response(List<TrebuchetWebApiDataContractsUsersUserV2> users = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Users = users;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsUsersUserReadV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserReadV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsUsersUserReadV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserReadV2Response input)
        {
            if (input == null)
                return false;
