...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse :  IEquatable<TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse(string name = default, string standInKey = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Name = name;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsCoreSaveGalleryImageResponse input)
        {
            if (input == null)
                return false;
