...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse input)
        {
            if (input == null)
                return false;
