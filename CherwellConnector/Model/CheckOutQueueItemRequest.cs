...
{
    /// <summary>
    ///     CheckOutQueueItemRequest
    /// </summary>
    [DataContract]
    public sealed class CheckOutQueueItemRequest : IEquatable<CheckOutQueueItemRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CheckOutQueueItemRequest(string busObId = default, string busObRecId = default,
        ...
        /// <summary>
        ///     Returns true if CheckOutQueueItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckOutQueueItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckOutQueueItemRequest input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckOutQueueItemRequest {\n");
        ...
        {
            return Equals(input as CheckOutQueueItemRequest);
        }
