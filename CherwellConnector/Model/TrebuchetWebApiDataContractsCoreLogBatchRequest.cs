...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsCoreLogBatchRequest :  IEquatable<TrebuchetWebApiDataContractsCoreLogBatchRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsCoreLogBatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsCoreLogBatchRequest input)
        {
            if (input == null)
                return false;
