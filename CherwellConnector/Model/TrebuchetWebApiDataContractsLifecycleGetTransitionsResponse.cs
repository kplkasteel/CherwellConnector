...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse :  IEquatable<TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse(List<TrebuchetWebApiDataContractsLifecycleGetTransitionsResponseTransition> transitions = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsLifecycleGetTransitionsResponse input)
        {
            if (input == null)
                return false;
