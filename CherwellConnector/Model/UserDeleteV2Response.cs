...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class UserDeleteV2Response :  IEquatable<UserDeleteV2Response>, IValidatableObject
    {
        ...
        public UserDeleteV2Response(string userRecordId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as UserDeleteV2Response);
        }
