...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse :  IEquatable<TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse(string historyRecId = default, string historyText = default, string historyTypeId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsQueuesRemoveItemFromQueueResponse input)
        {
            if (input == null)
                return false;
