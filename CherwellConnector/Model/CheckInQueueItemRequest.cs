...
{
    /// <summary>
    ///     CheckInQueueItemRequest
    /// </summary>
    [DataContract]
    public sealed class CheckInQueueItemRequest : IEquatable<CheckInQueueItemRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public CheckInQueueItemRequest(string busObId = default, string busObRecId = default,
        ...
        /// <summary>
        ///     Returns true if CheckInQueueItemRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckInQueueItemRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckInQueueItemRequest input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckInQueueItemRequest {\n");
        ...
        {
            return Equals(input as CheckInQueueItemRequest);
        }
