...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityRoleReadV2Response :  IEquatable<TrebuchetWebApiDataContractsSecurityRoleReadV2Response>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsSecurityRoleReadV2Response(List<TrebuchetWebApiDataContractsSecurityRole> roles = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Roles = roles;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSecurityRoleReadV2Response);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsSecurityRoleReadV2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityRoleReadV2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityRoleReadV2Response input)
        {
            if (input == null)
                return false;
