...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSearchesSearchFolder :  IEquatable<TrebuchetWebApiDataContractsSearchesSearchFolder>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsSearchesSearchFolder);
        }
