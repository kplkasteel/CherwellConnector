...
namespace CherwellConnector.Model
{
    ...
    public sealed class SimpleResultsList :  IEquatable<SimpleResultsList>, IValidatableObject
    {
        ...
        public SimpleResultsList(List<SimpleResultsListGroup> groups = default, string title = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            Groups = groups;
            Title = title;
            ErrorCode = errorCode;
