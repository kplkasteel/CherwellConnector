...
namespace CherwellConnector.Model
{
    ...
    public sealed class ApprovalsResponse :  IEquatable<ApprovalsResponse>, IValidatableObject
    {
        ...
        public ApprovalsResponse(int? totalRecords = default, List<ApprovalReadResponse> approvals = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsApprovalGetApprovalsResponse to be compared</param>
        /// <returns>Boolean</returns>
