...
namespace CherwellConnector.Model
{
    ...
    public sealed class FieldDefinition : IEquatable<FieldDefinition>, IValidatableObject
    {
        ...
        public FieldDefinition(bool? autoFill = default, bool? calculated = default, string category = default,
            int? decimalDigits = default, string description = default, string details = default,
            string displayName = default, bool? enabled = default, string fieldId = default, bool? hasDate = default,
            bool? hasTime = default, bool? isFullTextSearchable = default, string maximumSize = default,
            string name = default, bool? readOnly = default, bool? required = default, string type = default,
            string typeLocalized = default, bool? validated = default, int? wholeDigits = default)
        {
            AutoFill = autoFill;
