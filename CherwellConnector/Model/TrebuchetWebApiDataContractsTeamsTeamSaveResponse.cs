...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsTeamSaveResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsTeamSaveResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsTeamSaveResponse(string teamId = default, string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            TeamId = teamId;
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsTeamSaveResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsTeamSaveResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsTeamSaveResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsTeamSaveResponse input)
        {
            if (input == null)
                return false;
