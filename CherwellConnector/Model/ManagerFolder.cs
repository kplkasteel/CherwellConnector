...
namespace CherwellConnector.Model
{
    ...
    public sealed class ManagerFolder : IEquatable<ManagerFolder>, IValidatableObject
    {
        ...
        public ManagerFolder(string association = default, List<ManagerFolder> childFolders = default,
            List<ManagerItem> childItems = default, string id = default, List<Link> links = default,
            string localizedScopeName = default, string name = default, string parentId = default,
