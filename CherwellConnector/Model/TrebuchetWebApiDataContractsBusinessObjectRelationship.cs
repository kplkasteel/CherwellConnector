...
namespace CherwellConnector.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectRelationship :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectRelationship>, IValidatableObject
    {
        ...
        public TrebuchetWebApiDataContractsBusinessObjectRelationship(string cardinality = default, string description = default, string displayName = default, List<FieldDefinition> fieldDefinitions = default, string relationshipId = default, string target = default)
        {
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsBusinessObjectRelationship);
        }
