...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse(string errorCode = default, string errorMessage = default, bool? hasError = default, HttpStatusCodeEnum? httpStatusCode = default)
        {
            ErrorCode = errorCode;
        ...
        {
            return Equals(input as TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsAddUserToTeamResponse input)
        {
            if (input == null)
                return false;
