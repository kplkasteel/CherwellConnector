...
namespace CherwellConnector.Model
{
    ...
    /// </summary>
    [DataContract]
    public sealed class TrebuchetWebApiDataContractsSecurityApiClientSettingResponse :  IEquatable<TrebuchetWebApiDataContractsSecurityApiClientSettingResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">Instance of TrebuchetWebApiDataContractsSecurityApiClientSettingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsSecurityApiClientSettingResponse input)
        {
            if (input == null)
                return false;
