    ...
    public class OneStepActionsApi : BaseApi, IOneStepActionsApi
    {
        ...
        public static OneStepActionsApi Instance
        {
            get
            {
                lock (Padlock)
                {
                    _instance ??= new OneStepActionsApi(ServiceApi.Instance.Configuration);
        ...
        /// <summary>
        ///     Get One-Step Actions by Folder Operation to get One-Step Actions by Association, Scope, Scope Owner in a specific
        ///     folder.
        /// </summary>
        ...
        /// <summary>
        ///     Run a One-Step Action for a Business Object record Operation to run a One-Step Action for a Business Object record
        ///     by Business Object ID and Business Object Record ID.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        ...
        /// <summary>
        ///     Run a stand alone One-Step Action Operation to run a One-Step Action that doesn&#39;t run against a Business Object
        ///     Record.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
        /// <param name="standinkey">The key to find the One-Step Action to run</param>
        ...
        /// <summary>
        ///     Run a One-Step Action using a OneStepActionRequest Operation to run a One-Step Action using a OneStepActionRequest.
        ///     This request is used to start a One-Step Action run with additional information such as prompt values.
        /// </summary>
        /// <exception cref="ApiException">Thrown when fails to make API call</exception>
